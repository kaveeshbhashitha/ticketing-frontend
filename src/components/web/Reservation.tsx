...
const Reservation: React.FC = () => {
  ...
  const handleRegister = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (!eventId) throw new Error("Event ID is missing.");
      if (event) {
        const totalCharge = event.oneTicketPrice * ticketCount;
        const respone = await addReservation(
          userId,
          eventId,
          ticketCount,
          totalCharge,
          event.oneTicketPrice
        );
        if (respone) {
                    ...
                    <div className="col-6 mt-3 text-center">
                      <div className="mx-3">
                        ...
                        <div className="d-flex justify-content-center">
                          {ticketCount > 0 ? (
                            <button
                              className="ticketcountbutton buttonforres"
                    ...
                    <div className="col-6 mt-3 text-center">
                      <div className="mx-3">
                        <h3 className="text-white">
                          ...
                          {event.eventName} organized by {event.eventOrganizer}
                        </h3>
                ...
                <div>
                  <div className="row">
                    ...
                    <div className="col-6 mt-3 text-center">
                      <div className="mx-3">
                        <h3 className="text-white">
                          <i className="fa-solid fa-compact-disc mr-2"></i>
                          Theater {event.eventName} by {event.eventOrganizer}
                        </h3>
                        ...
                        <div className="w-100 d-flex justify-content-center align-items-center mx-auto">
                          ...
                          <p className="text-white mx-3">
                            <i className="fa-regular fa-clock mx-2"></i>{" "}
                            {event.theaterTime1} | {event.theaterTime2} |
                    ...
                    <div className="col-6 mt-3 text-center">
                      <div className="mx-3">
                        <h3 className="text-white">
                          ...
                          {event.eventName} is organized by{" "}
