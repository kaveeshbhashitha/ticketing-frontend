...
const SideBar: React.FC = () => {
  return (
    <div>
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme" style={{height: "100%"}}>
          ...
          <ul className="menu-inner py-1">
            ...
            <li className="menu-header small text-uppercase"><span className="menu-header-text">Services</span></li>
            <li className="menu-item">
                <NavLink to="/" className={({ isActive }) => isActive ? 'menu-link active' : 'menu-link'}>
            ...
            <li className="menu-header small text-uppercase"><span className="menu-header-text">Actions</span></li>
            <li className="menu-item">
